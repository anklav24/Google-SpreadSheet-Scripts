...
{       
    ...
    var colsSourceSheet=sourceSheet.getLastColumn();  // Получть последний столбец
    ...
    var i = rowsTargetSheet+1
    targetSheet.getRange(i, 1, 1, colsTargetSheet).setValues(sourceCellValues);  // Set values to target cell range getRange(row, column, numRows, numColumns)
}